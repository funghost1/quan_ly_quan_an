...
<div class="card">
        <div class="card-header">
            <br>
            <h1 class="card-title">Danh Sách Đơn Hàng Chưa Xử Lý</h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    <!-- truy vấn lấy du liệu -->
                     <?php
                        $sql_dangcho="SELECT * FROM don_han WHERE trang_thai = '1' ORDER BY `don_han`.`id` DESC";
                    ...
                    <tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-3 ">
                                <span class="badge bg-success"><a href="xuly_danggiao.php?id=<?php echo $row['id']; ?>">Chấp Nhận</a></span>
                            </div>
