...
<body>
    ...
    <div class="container">
        <table id="cart" class="table table-hover table-condensed">
            ...
            <tbody>
                <?php
                    $sql = "SELECT * FROM `chitiet_datban_luu` WHERE id_don_hangg = '$id_donhang'";
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td><a href="ds_banan_dathanhtoan.php" class="btn btn-success btn-block">Trở Về <i class="fa fa-angle-right"></i></a>
                    </td>
                </tr>
            </tfoot>
        </table>
