        ...
        <table id="cart" class="table table-hover table-condensed">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td><a href="ds_donhang_dangcho.php" class="btn btn-success btn-block">Trở Về <i class="fa fa-angle-right"></i></a>
                    <a href="inhoadon.php?id=<?php echo $id_donhang ?>" class="btn btn-success btn-block">In Hóa Đơn <i class="fa fa-angle-right"></i></a>
                    </td>
                </tr>
            </tfoot>
        </table>
