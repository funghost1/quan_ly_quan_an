...
<body>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Danh Sách Đơn Hàng Đã Mua</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tbody>
                    <!-- truy vấn lấy du liệu -->
                     <?php
                        $sql_dangcho="SELECT * FROM don_han WHERE id_khach_hang = '$id_thanhvien' AND trang_thai = '2' ORDER BY `don_han`.`id` DESC";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="container">
                                <h4><span class="badge bg-danger"><a href="chitietdonhangdamua.php?id=<?php echo $row['id']; ?>">Xem Chi Tiết</a></span></h4>
