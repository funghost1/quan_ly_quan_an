            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <!-- truy vấn lấy du liệu -->
                     <?php
                        $sql_dangcho="SELECT * FROM don_han WHERE id_khach_hang = '$id_thanhvien' AND trang_thai = '3' ORDER BY `don_han`.`id` DESC";
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-success">Thất Bại</span></td>
                        <td><?php echo number_format($row['tong_tien'] ,0,",",".");  ?>VNĐ</td>
                        <td>
                            <div class="container">
                                <h4><span class="badge bg-danger"><a href="chitietdonhangdahuy.php?id=<?php echo $row['id']; ?>">Xem Chi Tiết</a></span></h4>
