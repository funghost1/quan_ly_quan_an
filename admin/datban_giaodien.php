<?php
    ...
    if(isset($_POST["order"])){
      ...
      if(empty($_POST["total"]) || empty($_POST["soban"])){
        echo '<script type = "text/javascript">';
        echo 'alert("Bạn Chưa Chọn Bàn Hoặc Giỏ Hàng Trống!");';
        echo 'window.location.href = "datban_giaodien.php" ';
        echo '</script>';
      }else{
    ...
    <form action="datban_giaodien.php" method="post">
      <div class="cart transition is-open">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-2 ">
              <a type="btn" class="btn btn-update"  href="taoban.php"> Chọn Bàn </a>
            </div>
            <div  class="col-sm-6 col-md-2 ">
  ...
  <form action="datban_giaodien.php" method="post">
        ...
        <div class="row">
          <div class="form-group col-md-3">
              <input class="form-control" type="text" name="ho_ten" id="ten" placeholder="Nhập Họ Tên" >
          </div>

          <div class="form-group col-md-6">
              <input class="form-control" type="number" min="1" name="soluong" id="diachi" placeholder="Nhập Số Lượng Người" >
          </div>

          <div class="form-group col-md-3">
            
              <input class="form-control" type="number" name="phone" id="sdt" placeholder="Nhập Số Điện Thoại" > 
              <input type="hidden" name="total" value="<?php echo $tongdonhan; ?>" >
              <input type="hidden" name="soban" value="<?php echo $soban; ?>" >
              <?php $thanhvien = isset($_SESSION['Username_nhanvien']) ? $_SESSION['Username_nhanvien'] : ''; ?>
