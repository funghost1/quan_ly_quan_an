...
<header>
    ...
    <div class="icons">
        ...
        <a href="giohang_giaodien.php" class="fas fa-shopping-cart"><span class="badge badge-danger navbar-badge" style="color: red;" style="border: cornsilk;"><?php echo $soluong; ?></span></a>
...
<section class="menu" id="menu">
    ...
    <div class="container-fluid" align="center">
        <a href="hehe.php?id=1#menu" class="btn btn-success"> Lẩu </a> &nbsp;&nbsp;
        <a href="hehe.php?id=2#menu" class="btn btn-primary"> Xào </a> &nbsp;&nbsp;
        <a href="hehe.php?id=3#menu" class="btn btn-primary"> Nướng </a> &nbsp;&nbsp;
        <a href="hehe.php?id=4#menu" class="btn btn-primary"> Nước </a> &nbsp;&nbsp;
        <a href="hehe.php?id=5#menu" class="btn btn-primary"> Khác </a> 
...
<section class="" id="order">
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3 ">
            <form action="">
                    <div class="input">   
                        <button class="btn btn- primary" >Bàn số 1</button>
                    </div>
            </form>
        </div>
        <div class="col-sm-6 col-lg-3 ">
